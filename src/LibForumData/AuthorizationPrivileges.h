...
namespace Forum::Authorization
{
    ...
    enum class ForumWidePrivilege : EnumIntType
    {
        ...
        VIEW_ATTACHMENT_IP_ADDRESS,
        CHANGE_OWN_ATTACHMENT_NAME,
    ...
    const ForumWidePrivilege ForumWidePrivilegesToSerialize[] =
    {
        ...
        ForumWidePrivilege::GET_ATTACHMENTS_OF_USER,
        ...
        ForumWidePrivilege::DELETE_OWN_ATTACHMENT,
        ForumWidePrivilege::DELETE_ANY_ATTACHMENT,
        ForumWidePrivilege::GET_ALL_ATTACHMENTS,
        ForumWidePrivilege::VIEW_ATTACHMENT_IP_ADDRESS,
        ForumWidePrivilege::CHANGE_OWN_ATTACHMENT_NAME,
