...
namespace Forum::Repository
{
    ...
    */
    ...
    class MemoryRepositoryBase : public IObservableRepository, boost::noncopyable
    {
    public:
    ...
    inline void updateThreadLastUpdated(Entities::DiscussionThread& thread, const Entities::UserPtr currentUser)
    {
