...
{
    class DefaultAuthorization final : public IUserAuthorization,
    ...
    public:
        ...
        AuthorizationStatus getAllowForumWidePrivilegeChange(const Entities::User& currentUser) const override;
